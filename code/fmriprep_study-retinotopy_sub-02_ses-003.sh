...
if [ -e $LOCAL_DATASET/resource_monitor.json ] ; cp $LOCAL_DATASET/resource_monitor.json /scratch/bpinsard/fmriprep_study-retinotopy_sub-02_ses-003_resource_monitor.json 
