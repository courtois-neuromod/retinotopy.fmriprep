...
cp $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-01_ses-002/resource_monitor.json /scratch/bpinsard/fmriprep_study-retinotopy_sub-01_ses-002_resource_monitor.json 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-01_ses-002 /scratch/bpinsard/fmriprep_study-retinotopy_sub-01_ses-002 ; fi 
