...
cp $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-01_ses-006/resource_monitor.json /scratch/bpinsard/fmriprep_study-retinotopy_sub-01_ses-006_resource_monitor.json 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-01_ses-006 /scratch/bpinsard/fmriprep_study-retinotopy_sub-01_ses-006 ; fi 
