...
cp $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-02_ses-001/resource_monitor.json /scratch/bpinsard/fmriprep_study-retinotopy_sub-02_ses-001_resource_monitor.json 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-02_ses-001 /scratch/bpinsard/fmriprep_study-retinotopy_sub-02_ses-001 ; fi 
