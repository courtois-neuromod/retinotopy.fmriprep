...
cp $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-03_ses-004/resource_monitor.json /scratch/bpinsard/fmriprep_study-retinotopy_sub-03_ses-004_resource_monitor.json 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $SLURM_TMPDIR/fmriprep_study-retinotopy_sub-03_ses-004 /scratch/bpinsard/fmriprep_study-retinotopy_sub-03_ses-004 ; fi 
